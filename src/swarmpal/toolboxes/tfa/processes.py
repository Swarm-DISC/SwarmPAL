...
class Preprocess(PalProcess):
    ...
    def _flag_cleaning(self, ds):
        ...
        flagname = flagname if flagname else FLAG_THRESHOLDS[varname.replace("_res_Model","")]["flag_name"]
        max_val = max_val if max_val else FLAG_THRESHOLDS[varname.replace("_res_Model","")]["max_val"]
